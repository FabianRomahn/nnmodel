...
void printInput(Eigen::VectorXd const& input)
{
...
void printOutput(Eigen::VectorXd const& output)
{
...
void printGradient(Eigen::MatrixXd const& gradient)
{
...
int main(int argc, char * argv[])
{
	...
	Eigen::VectorXd input (model.getInputDimension());
	Eigen::VectorXd output (model.getOutputDimension());
